...
class ApiService {
  static Future<void> register({
    ...
    // Example: simulate some validation / failure cases
    if (username.length < 4) {
      throw Exception("Username must be at least 4 characters");
    }
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      ...
      // Most common pattern: return to login screen after successful registration
